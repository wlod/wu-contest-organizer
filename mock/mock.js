...
(function() {
    ...
    $(window).on('hashchange', function() {
        if(lastClickOnNavigationTabId !== location.hash) {
            ...
            $('#navigation').find('a[href="' + tabPanePrefix + locationHashId + '"]').click();
    ...
    $(window).on('beforeunload', function(){
          if(currentHash.substring(tabPanePrefix.length) !== lastClickOnNavigationTabId) {
               return 'Are you sure you want to leave?';
          }
    })

    $('#navigation a, #navigation button').on('click', function (e) {
        try {
